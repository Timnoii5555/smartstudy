    ...
    const DICT = {
        th: {
            ...
            modalGroups: {
                ...
                joinBtn: 'เข้าร่วม',
                createBtn: 'สร้างกลุ่มใหม่',
                publicSection: 'กลุ่มสาธารณะ',
                publicEmpty: 'ยังไม่มีกลุ่มสาธารณะ — เป็นคนแรกที่สร้างได้เลย',
                nameLabel: 'ชื่อกลุ่ม',
                goalLabel: 'เป้าหมายต่อวัน (นาที)',
                publicToggle: 'แสดงกลุ่มนี้แบบสาธารณะ',
                codeLabel: 'รหัสเข้ากลุ่ม',
                codeHint: 'แชร์รหัสนี้ให้เพื่อนเพื่อเข้าร่วมกลุ่ม',
                leaveBtn: 'ออกจากกลุ่มนี้',
                studyingNow: '🟢 กำลังอ่านหนังสืออยู่ {n} คน',
                studyingUnknown: 'ยังตรวจสอบไม่ได้ตอนนี้',
                minutesValue: '{n} นาที/วัน',
                unavailable: 'ฟีเจอร์นี้ยังไม่พร้อมใช้งานในตอนนี้',
                errName: 'กรุณาตั้งชื่อกลุ่มก่อนครับ',
                errGeneric: 'สร้างกลุ่มไม่สำเร็จ ลองอีกครั้งนะครับ',
        ...
        en: {
            ...
            modalGroups: {
                ...
                publicSection: 'Public groups',
                publicEmpty: 'No public groups yet — be the first to create one.',
                nameLabel: 'Group name',
                goalLabel: 'Daily goal (minutes)',
                publicToggle: 'List this group publicly',
                codeLabel: 'Join code',
                codeHint: 'Share this code so friends can join.',
                leaveBtn: 'Leave this group',
                studyingNow: '🟢 {n} studying right now',
                studyingUnknown: "Can't check right now",
                minutesValue: '{n} min/day',
                unavailable: "This feature isn't available right now",
                errName: 'Please name your group first.',
                errGeneric: "Couldn't create the group — try again.",
