    ...
    const DICT = {
        th: {
            ...
            landing: {
                ...
                whyTitle: 'ทำไมต้อง SmartStudy',
                feat1Title: 'หลักสูตร TCAS จริง ครบในตัว',
                feat1Desc: 'วิชาจริง 23 วิชาขึ้นไป — TGAT, TPAT1-5, A-Level ทุกวิชา — หรือสร้างวิชาและหัวข้อของตัวเองได้ในไม่กี่วินาที',
                feat2Title: 'แผนที่ปรับตามคุณจริงๆ',
                feat2Desc: 'บอกแค่วันสอบและสไตล์การเรียงลำดับที่ชอบ ระบบจะสร้างแผนอ่านรายวันให้อัตโนมัติ',
                newBadge: 'ใหม่',
                feat3Title: 'คะแนนความพร้อมสอบที่ซื่อสัตย์กว่าเดิม',
                feat3Desc: 'ไม่ใช่แค่ "% เนื้อหาที่อ่านจบ" แต่รวมความสม่ำเสมอในการอ่านด้วย หักดิบอ่านรวดเดียวคืนก่อนสอบจะไม่ได้คะแนนหลอกตาแบบนั้น',
                feat4Title: 'เควส แต้ม สตรีค และกระดานผู้นำ',
                feat4Desc: 'เควสประจำวันและสตรีคทำให้การมาอ่านหนังสือกลายเป็นนิสัย พร้อมแต้มสะสมและกระดานผู้นำแข่งกับคนอื่นแบบสดๆ',
                feat5Title: 'เสียงโฟกัสที่สร้างสดต่อหน้าคุณ',
                feat5Desc: 'เสียงบรรยากาศ 6 แบบสังเคราะห์สดในเบราว์เซอร์ ไม่ใช่ไฟล์ mp3 วนลูป แถมอัปโหลดเสียงของตัวเองได้',
                feat6Title: 'ข้อมูลของคุณเป็นของคุณ',
                feat6Desc: 'ใช้งานออฟไลน์ได้เต็มรูปแบบ เก็บข้อมูลในเครื่องคุณเองเป็นค่าเริ่มต้น และไม่มีโฆษณาให้กวนใจ',
        ...
        en: {
            ...
            landing: {
                ...
                whyTitle: 'Why SmartStudy',
                feat1Title: 'The real TCAS curriculum, built in',
                feat1Desc: '23+ real subjects — TGAT, TPAT1-5, every A-Level — or define your own subject and topics in seconds.',
                feat2Title: 'A plan that actually adapts',
                feat2Desc: 'Tell it your exam date and how you like to sequence hard vs. easy topics — the day-by-day plan is generated for you, automatically.',
                newBadge: 'New',
                feat3Title: 'One honest readiness score',
                feat3Desc: 'Not just "% of content read" — a composite score that also weighs how consistently you show up, so cramming everything the night before doesn\'t fake you out.',
                feat4Title: 'Quests, points, streaks & a leaderboard',
                feat4Desc: 'Daily quests and a day-streak turn showing up into a habit, with points and a live leaderboard against other learners.',
                feat5Title: 'Focus sounds generated live',
                feat5Desc: 'Six ambient sounds synthesized in your browser in real time — not looping mp3 files — plus upload your own.',
                feat6Title: 'Your data stays yours',
                feat6Desc: 'Works fully offline, stores everything on your own device by default, and never shows you an ad.',
